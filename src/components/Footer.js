          ...
          <div className="rowy">
            <div className="footer-col">
              ...
              <ul className="nav-items">
                <li><a href="/Law-Firm/o-meni#opsirnije">&gt; O meni</a></li>
                <li><a href="#moje-usluge">&gt; Moje usluge</a></li>
                <li><a href="/Law-Firm/privatnost-informacija#privatnost">&gt; Privatnost informacija</a></li>
                <li><a href="/Law-Firm/uvjeti-pružanja-usluge#uvjeti-web">&gt; Uvjeti pružanja usluge</a></li>
              </ul>
            </div>
            <div className="footer-col">
              <h4>Navigacija</h4>
              <ul className="nav-items">
                <li><a href="/Law-Firm/tarifa#tarifa-info">&gt; Tarifa</a></li>
                <li><a href="/Law-Firm/najčešća-pitanja#faq">&gt; Česta pitanja</a></li>
                <li><a href="/Law-Firm/pravne-oblasti#lista-oblasti">&gt; Oblasti</a></li>
                <li><a href="/Law-Firm/pravni-postupci#lista-postupaka">&gt; Postupci</a></li>
